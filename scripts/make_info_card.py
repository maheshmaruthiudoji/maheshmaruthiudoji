...
# ===========================================================================
HOST = "mahesh"   # shown as  mahesh@github  in the header

ROWS = [
    ("host",),
    ("kv", "Name", "Mahesh Udoji"),
    ("kv", "Title", "Data Analyst | Data Scientist | AI/ML Engineer"),
    ("kv", "Edu", "B.E. AI & ML, City Engineering College '26"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, SQL (MySQL)"),
    ("kv", "BI Tools", "Power BI, Excel, Tableau"),
    ("kv", "Data/ML", "Pandas, NumPy, Scikit-learn, TensorFlow"),
    ("kv", "Concepts", "ML, Deep Learning, NLP, AI"),
    ("kv", "Tools", "Git & GitHub"),
    ("gap",),
    ("sec", "Core Skills"),
    ("bul", "Data Cleaning · EDA"),
    ("bul", "Dashboard Development · KPI Reporting"),
    ("bul", "Feature Engineering · Predictive Modeling"),
    ("bul", "REST APIs · Git & GitHub"),
    ("gap",),
    ("sec", "Currently Learning"),
    ("kv", "Now", "Deep Learning, Generative AI"),
    ("kv", "Also", "Data Engineering, System Design"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "Amazon Review Sentiment Analysis"),
    ("bul", "Sports Data Analytics Platform"),
    ("bul", "Sales Analytics Dashboard"),
    ("bul", "Power BI Business Intelligence Dashboards"),
    ("bul", "E-Commerce Customer Analytics Dashboard"),
    ("bul", "Channapatna - Namma Pride Android App"),
    ("bul", "Face Recognition Attendance System"),
    ("gap",),
    ("sec", "Experience"),
    ("bul", "Data Scientist Trainee - Besant Technologies"),
    ("bul", "AI Intern - Microsoft & SAP TechSaksham"),
    ("bul", "Android App Dev Intern - MindMatrix"),
    ("gap",),
    ("sec", "Achievements"),
    ("bul", "AI Transformative Learning Internship (MS & SAP CSR)"),
    ("bul", "2nd Place - Technical Project Exhibition 2025"),
    ("bul", "MindMatrix Industry Internship 2026"),
    ("bul", "10+ End-to-End Data Analytics & AI Projects"),
    ("bul", "Active SQL & DSA Problem Solver"),
    ("gap",),
    ("kv", "Motto", '"Transforming Data into Intelligent Decisions."'),
]
